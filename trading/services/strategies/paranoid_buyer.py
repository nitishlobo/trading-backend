...
class ParanoidBuyer(Strategy):
    """Paranoid buying strategy."""
    ...
    def get_profitable_trades(  # pylint: disable=too-many-locals
        ...
        should_trade = self.is_trade_possible(data, data_cols, trade_interval)
        ...
        while should_trade:
            ...
            completed_trade = CompletedTrade(
                opening=Trade(
                    time=opening_trade[time_col].item(),
                    price=opening_trade[price_col].item(),
                ),
                closing=Trade(
                    time=closing_trade[time_col].item(),
                    price=closing_trade[price_col].item(),
                ),
            )
